...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20181215-acs-housing-costs">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20181215-acs-housing-costs/",
      "url": "http://static.startribune.com/news/projects-staging/all/20181215-acs-housing-costs/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20181215-acs-housing-costs/",
      "url": "http://static.startribune.com/news/projects/all/20181215-acs-housing-costs/"
    }
  }
}
```
